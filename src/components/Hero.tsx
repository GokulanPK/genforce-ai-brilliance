      ...
      <div className="container-custom relative z-10 pt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <br />
            <span className="gradient-text text-glow">Digital Solutions</span>
            <br />
          ...
          >
            We design AI-powered products, full-stack web platforms, and automation solutions 
          ...
          >
            <Button
              ...
              size="lg"
              className="bg-primary text-primary-foreground hover:bg-primary/90 font-semibold px-8 py-6 text-base group glow-effect"
            >
              View Our Work
